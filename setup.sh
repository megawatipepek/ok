...
state=Indonesia
locality=Indonesia
organization=AYRPratama
organizationalunit=AYRPratama
...
cat> /etc/issue.net << END
		    <br><font color="#008000"><b>SLEBEEWWW</br></font><br>
		      <font color="#008000"><b>MELEDAAAKKKSSS</b></font><br>
	          <font color="#008000"><b>CCUUUUUWWWAAAAKSSSSSS</br></font><br>
END
cd
chown -R www-data:www-data /home/vps/public_html
/etc/init.d/nginx restart
...
bash acme.sh --installcert -d $domain --fullchainpath /root/.cert --keypath /root/.key

#ssl
cat /root/.cert /root/.key | tee /etc/haproxy/funny.pem
...
echo -e "KISS TERLEBIH DAHULU, REMAS TT NYA, HISAPPUTINGNYA, JILMEK, LALU COLMEK" 
echo -e "INGAT BIKIN PASANGANMU KLIMAKS DULUAN" 
echo -e "" 
echo -e "Untuk membuka panel AutoSC Masukan" 
echo -e "perintah ( alif ) tanpa tanda kurung" 
echo -e "" 
